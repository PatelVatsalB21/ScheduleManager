...
public class Trash_Task_rec_adapter extends
        RecyclerView.Adapter<Trash_Task_rec_adapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.trash_task_layout,
                null);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        holder.lottieAnimationView.setAnimation(
                UtilsArray_Task.category.get(trashTasks.get(position).LottieFileRes).LottieRes);
            ...
            new androidx.appcompat.view.ActionMode.Callback() {
                ...
                public boolean onActionItemClicked(androidx.appcompat.view.ActionMode actionMode,
                    ...
                    if (item.getTitle() == "Restore") {
                        ...
                        Snackbar.make(Trash_frag_1.trash_task_rec_view,
                                "Task restored successfully", Snackbar.LENGTH_SHORT).show();
                        ...
                        notifyDataSetChanged();
                        UtilsArray_Trash.UpdateTrashTask(trashTasks, context);
                        Snackbar.make(Trash_frag_1.trash_task_rec_view, "Task deleted successfully",
