        ...
        update_Data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(BackupSettings.this)
                        ...
                        .setMessage("Are you sure you want to update data. This will store all your created data in server?")
                        ...
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if (conMgr.getActiveNetworkInfo() != null && conMgr.getActiveNetworkInfo().isAvailable() && conMgr.getActiveNetworkInfo().isConnected()) {
                                    ...
                                    if (!UtilsArray_Task.task.isEmpty()|!UtilsArraylist.note.isEmpty()|!UtilsArray_Email.mail.isEmpty()){
                                    ...
                                    AllData.add(2, GsonConverter.EmailToJson(UtilsArray_Email.mail));
                                        ...
                                        mDatabase.child(uid).setValue(AllData).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            @Override
                                            public void onComplete(@NonNull Task<Void> task) {
                                                Toast.makeText(BackupSettings.this, "Data Updated Successfully", Toast.LENGTH_SHORT).show();
                                            }
                                        }).addOnFailureListener(new OnFailureListener() {
                                            @Override
                                            public void onFailure(@NonNull Exception e) {
                                                Toast.makeText(BackupSettings.this, "Some Error Occurred", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                                    }else Toast.makeText(BackupSettings.this, "Nothing to upload", Toast.LENGTH_SHORT).show();
                                    if (pdialog.isShowing())pdialog.dismiss();
                                } else {
                                    Toast.makeText(BackupSettings.this, "Please Check Internet Connection", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
        ...
        restore_data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(BackupSettings.this)
                        ...
                        .setMessage("Are you sure you want to restore data. This will remove all changes made including data created by you?")
                        .setNegativeButton(android.R.string.no, null)
                        .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if (conMgr.getActiveNetworkInfo() != null && conMgr.getActiveNetworkInfo().isAvailable() && conMgr.getActiveNetworkInfo().isConnected()) {
                                    ...
                                    thisUser.addListenerForSingleValueEvent(new ValueEventListener() {
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                            ...
                                            Log.e("ALLDATARESTORE", String.valueOf(AllData.size()));
                                            if (AllData != null && AllData.size() != 0) {

                                                if (!GsonConverter.jsonToTask(AllData.get(0)).isEmpty()|!GsonConverter.jsonToArray(AllData.get(1)).isEmpty()|!GsonConverter.jsonToEmail(AllData.get(2)).isEmpty()) {

                                                    UtilsArray_Task.UpdateTask(GsonConverter.jsonToTask(AllData.get(0)), BackupSettings.this);
                                                    UtilsArraylist.UpdateNote(GsonConverter.jsonToArray(AllData.get(1)), BackupSettings.this);
                                                    UtilsArray_Email.UpdateMail(GsonConverter.jsonToEmail(AllData.get(2)), BackupSettings.this);

//                                                if (UtilsArraylist.notesPendingIntents!=null)
//                                                    UtilsArraylist.notesPendingIntents.clear();
//                                                if (UtilsArray_Task.taskPendingIntent!=null)
//                                                    UtilsArray_Task.taskPendingIntent.clear();
//                                                if (UtilsArray_Email.emailPenInt!=null)
//                                                    UtilsArray_Email.emailPenInt.clear();
                                                    ...
                                                    Notes_rec_Adapter adapter2 = new Notes_rec_Adapter(BackupSettings.this, UtilsArraylist.getNote());
                                                    adapter2.notifyDataSetChanged();

                                                    Email_rec_Adapter adapter3 = new Email_rec_Adapter(UtilsArray_Email.getMail());
                                                    ...
                                                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                                                        alarmManager.setExact(AlarmManager.RTC_WAKEUP, System.currentTimeMillis(), PendingIntent.getBroadcast(BackupSettings.this, 0, new Intent(BackupSettings.this, BootReciever.class).putExtra("", true), PendingIntent.FLAG_UPDATE_CURRENT));
                                                    }

                                                    Toast.makeText(BackupSettings.this, "Data Restored Successfully.Restarting App to apply changes. ", Toast.LENGTH_SHORT).show();
                                                    startActivity(new Intent(BackupSettings.this, SplashScreen.class).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_NEW_TASK));
                                                    finish();
                                                }
                                                else Toast.makeText(BackupSettings.this, "No data found for your account ", Toast.LENGTH_SHORT).show();
                                                }else Toast.makeText(BackupSettings.this, "No data found for your account ", Toast.LENGTH_SHORT).show();
                                        }
