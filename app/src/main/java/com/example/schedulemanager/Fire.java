...
//
//public class Fire extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
...
//
//
//        DownloadManager.Query query = fStore.collection("notes").document(user.getUid()).collection("myNotes").orderBy("title", DownloadManager.Query.Direction.DESCENDING);
...
//            @Override
//            protected void onBindViewHolder(@NonNull NoteViewHolder noteViewHolder, final int i, @NonNull final Note com.example.firebase.note) {
//                noteViewHolder.noteTitle.setText(com.example.firebase.note.getTitle());
//                noteViewHolder.noteContent.setText(com.example.firebase.note.getContent());
